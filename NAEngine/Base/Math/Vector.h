...
#define NA_MM_REPLICATE_X_PS(v) _mm_shuffle_ps((v), (v), NA_MM_SHUFFLE_PARAM(0, 0, 0, 0))
#define NA_MM_REPLICATE_Y_PS(v) _mm_shuffle_ps((v), (v), NA_MM_SHUFFLE_PARAM(1, 1, 1, 1))
#define NA_MM_REPLICATE_Z_PS(v) _mm_shuffle_ps((v), (v), NA_MM_SHUFFLE_PARAM(2, 2, 2, 2))
#define NA_MM_REPLICATE_W_PS(v) _mm_shuffle_ps((v), (v), NA_MM_SHUFFLE_PARAM(3, 3, 3, 3))

#define NA_MM_MADD_PS(v1, v2, v3) _mm_add_ps(_mm_mul_ps((v1), (v2)), (v3))
